...
namespace SigncryptionProposed.Signcryption.Participants.Sender
{
    ...
    public class Sender : Signcryption
    {
        ...
        public Sender()
        {
            ...
            SecretKey = this.GenerateSecretKey1(keyGeneration.globalParameters.RandomNumberN);
            RandomNumberZ = this.GenerateRandomNumberZ(keyGeneration.globalParameters.RandomNumberN);
        ...
        {
            return this.SigncryptTheMessage(message, _PublicKeyReceiver, this.GeneratedNumberBeta, this.SecretKey, this.keyGeneration.globalParameters);
        }
        ...
        /// </returns>
        /// /// <remarks>
        /// Public key is not generated by the sender. the instance of <c>KeyGeneration</c> class 
        ...
        {
            return BigInteger.ModPow(RandomNumberZ, _PrivateKey, keyGeneration.globalParameters.RandomNumberN);
        }
        #endregion
    }
}
